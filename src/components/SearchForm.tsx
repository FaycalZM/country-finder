...
const SearchForm = () => {
    ...
    return (
        <form className='laptop:w-[35%] tablet:w-1/2 w-full h-fit flex items-center gap-4 text-dark-gray dark:text-very-light-gray bg-white dark:bg-dark-blue-dm px-6 py-3 rounded shadow'>
            <BiSearchAlt2 />
            <input
                ref={inputRef}
                onChange={() => {
